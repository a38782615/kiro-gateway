...
async def list_available_models(request: Request) -> JSONResponse:
    ...
    Returns:
        List of model objects with metadata (modelId, modelName, tokenLimits, etc.).
    """
    ...
    for model_id in model_ids:
        ...
        if model_info:
            ...
            models.append({
                ...
                "modelName": model_info.get("modelName", model_info.get("modelId")),
                "description": model_info.get("description", ""),
                "maxInputTokens": cache.get_max_input_tokens(model_id),
                "isHidden": model_info.get("_is_hidden", False),
            })
