...
async function loadModels() {
    ...
    try {
        ...
        if (data.last_update) {
            ...
            lastUpdateText = updateDate.toLocaleString('zh-CN');
        }
        ...
        container.innerHTML = `
            <div style="margin-bottom: 20px; padding: 15px; background: #161b22; border-radius: 8px; border: 1px solid #30363d;">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <strong>模型总数:</strong> ${data.total}
                    </div>
                    <div>
                        <strong>最后更新:</strong> ${lastUpdateText}
                    </div>
                </div>
            </div>
                ...
                <div class="data-item">
                    <div class="data-item-header">
                        <div class="data-item-title">
                            ${model.modelName}
                            ${model.isHidden ? '<span class="badge" style="background: #6e40c9; margin-left: 8px;">隐藏模型</span>' : ''}
                        </div>
                    </div>
                    <div class="data-item-body">
                        <div class="data-field">
                            <div class="data-field-label">模型 ID</div>
                            <div class="data-field-value" style="font-family: monospace;">${model.modelId}</div>
                        </div>
                        ${model.description ? `
                        <div class="data-field">
                            <div class="data-field-label">描述</div>
                            <div class="data-field-value">${model.description}</div>
                        </div>
                        ` : ''}
                        <div class="data-field">
                            <div class="data-field-label">最大输入 Token</div>
                            <div class="data-field-value">${model.maxInputTokens.toLocaleString()}</div>
                        </div>
                    </div>
                </div>
            `).join('')}
